...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Jul 2025 pada 10.33
...
CREATE TABLE `notifications` (
  ...
  `category` enum('announcement','order') NOT NULL,
  `date` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `orders` (
  ...
  `status` enum('waiting_payment','processing','shipped','completed','cancelled') DEFAULT 'waiting_payment',
...
CREATE TABLE `payments` (
  ...
  `order_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `method` enum('BCA','BRI','Mandiri') NOT NULL,
  `total` int(11) NOT NULL,
  `admin_fee` int(11) DEFAULT 0,
  `shipping_fee` int(11) DEFAULT 0,
  `virtual_code` varchar(50) NOT NULL,
...
CREATE TABLE `promos` (
  ...
  `method_required` enum('BCA','BRI','Mandiri') DEFAULT NULL,
...
--
-- Struktur dari tabel `promo_users`
--
...
ALTER TABLE `payments`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `virtual_code` (`virtual_code`),
  ADD KEY `order_id` (`order_id`),
  ADD KEY `user_id` (`user_id`);
...
--
-- Indeks untuk tabel `promo_users`
--
ALTER TABLE `promo_users`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_user_promo` (`promo_id`,`user_id`),
  ADD KEY `user_id` (`user_id`);
...
--
-- AUTO_INCREMENT untuk tabel `promo_users`
--
ALTER TABLE `promo_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`address_id`) REFERENCES `user_addresses` (`id`) ON DELETE CASCADE;
...
--
-- Ketidakleluasaan untuk tabel `promo_users`
--
ALTER TABLE `promo_users`
  ADD CONSTRAINT `promo_users_ibfk_1` FOREIGN KEY (`promo_id`) REFERENCES `promos` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `promo_users_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
